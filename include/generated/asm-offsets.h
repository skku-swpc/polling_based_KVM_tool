...
#define PV_CPU_usergs_sysret32 288 /* offsetof(struct pv_cpu_ops, usergs_sysret32)	# */
#define PV_CPU_usergs_sysret64 280 /* offsetof(struct pv_cpu_ops, usergs_sysret64)	# */
#define PV_CPU_swapgs 304 /* offsetof(struct pv_cpu_ops, swapgs)	# */
...
#define PARAVIRT_PATCH_pv_irq_ops 360 /* offsetof(struct paravirt_patch_template, pv_irq_ops)	# */
...
#define PV_CPU_iret 296 /* offsetof(struct pv_cpu_ops, iret)	# */
#define PV_CPU_irq_enable_sysexit 272 /* offsetof(struct pv_cpu_ops, irq_enable_sysexit)	# */
